...
@Repository
public interface StudentServiceRegistrationRepository extends JpaRepository<StudentServiceRegistration, Long>, JpaSpecificationExecutor<StudentServiceRegistration> {
